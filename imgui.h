...
namespace ImGui
{
    ...
    IMGUI_API void          Pickerbox(const char* label, bool* v, float color[3], ImGuiColorEditFlags flags);
    IMGUI_API void          Keybindbox(const char* label, bool* v, int* key, int* m);
    IMGUI_API void          KeybindPickerbox(const char* label, bool* v, int* key, int* m, float color[3], ImGuiColorEditFlags flags = 0);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, float val = 0, bool multi = false, ImGuiComboFlags flags = 0);
